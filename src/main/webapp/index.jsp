...
<header>
    ...
    <p>Feuille de route du projet Jakarta EE / Tomcat / IntelliJ</p>
...
<main>
    ...
    <section class="card">
        ...
        <ul>
            ...
            <li>Données temporaires en mémoire dans le service.</li>
        </ul>
    </section>
    ...
    <section class="card">
        ...
        <div class="step">
            ...
            <ol>
                <li>Créer une zone d’administration.</li>
                <li>Limiter l’ajout, la modification et la suppression aux admins.</li>
